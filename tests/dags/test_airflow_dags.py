    ...
    def test_dag_task_dependencies(self):
        ...
        try:
            ...
            tasks_with_dependencies = [
                task for task in dag.tasks if task.downstream_task_ids
            ]
            assert len(tasks_with_dependencies) > 0, (
                "DAG should have tasks with dependencies"
            )
...
class TestKedroOperator:
    ...
    def test_kedro_operator_execution(self, mock_session, mock_configure):
        ...
        try:
            ...
            mock_session.create.return_value.__enter__.return_value = (
