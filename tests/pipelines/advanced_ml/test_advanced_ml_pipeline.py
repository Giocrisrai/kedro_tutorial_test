...
class TestDataPreparation:
    ...
    def test_prepare_classification_data(self, sample_data, advanced_ml_parameters):
        ...
        X, y, label_encoder = prepare_classification_data(sample_data, advanced_ml_parameters)
...
class TestModelTraining:
    ...
    def test_train_regression_models(self, sample_data, advanced_ml_parameters):
        ...
        models = train_regression_models(X_train_scaled, y_train, cv_splitter, advanced_ml_parameters)
    ...
    def test_train_classification_models(self, sample_data, advanced_ml_parameters):
        ...
        models = train_classification_models(X_train_scaled, y_train, cv_splitter, advanced_ml_parameters)
...
class TestModelEvaluation:
    ...
    def test_evaluate_classification_models(self, sample_data, advanced_ml_parameters):
        ...
        evaluation = evaluate_classification_models(models, X_test_scaled, y_test, label_encoder)
...
class TestReportGeneration:
    ...
    def test_create_model_comparison_report(self, sample_data, advanced_ml_parameters):
        ...
        regression_evaluation = {
            ...
            'RandomForestRegressor': {'test_r2': 0.85, 'test_rmse': 9.8, 'test_mae': 7.5}
        }
        
        classification_evaluation = {
            'LogisticRegression': {'test_accuracy': 0.75, 'test_precision': 0.8, 'test_recall': 0.7, 'test_f1': 0.75},
            'RandomForestClassifier': {'test_accuracy': 0.8, 'test_precision': 0.85, 'test_recall': 0.75, 'test_f1': 0.8}
        }
...
class TestAdvancedMLPipeline:
    ...
    def test_advanced_ml_pipeline_execution(self, caplog, sample_data, advanced_ml_parameters):
        ...
        try:
            ...
            assert "Pipeline execution completed successfully" in caplog.text or str(e) != ""
