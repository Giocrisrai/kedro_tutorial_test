...
class TestDataIntegration:
    ...
    def integration_catalog(self, sample_raw_data):
        ...
        datasets = {
            ...
            "X_reg": MemoryDataset(pd.DataFrame()),
            "y_reg": MemoryDataset(pd.DataFrame()),
            "X_clf": MemoryDataset(pd.DataFrame()),
            "y_clf": MemoryDataset(pd.DataFrame()),
            "label_encoder": MemoryDataset(None),
            "X_reg_train": MemoryDataset(pd.DataFrame()),
            "X_reg_test": MemoryDataset(pd.DataFrame()),
            "y_reg_train": MemoryDataset(pd.DataFrame()),
            "y_reg_test": MemoryDataset(pd.DataFrame()),
            "X_clf_train": MemoryDataset(pd.DataFrame()),
            "X_clf_test": MemoryDataset(pd.DataFrame()),
            "y_clf_train": MemoryDataset(pd.DataFrame()),
            "y_clf_test": MemoryDataset(pd.DataFrame()),
            "X_reg_train_scaled": MemoryDataset(pd.DataFrame()),
            "X_reg_test_scaled": MemoryDataset(pd.DataFrame()),
            "X_clf_train_scaled": MemoryDataset(pd.DataFrame()),
            "X_clf_test_scaled": MemoryDataset(pd.DataFrame()),
            "scaler_reg": MemoryDataset(None),
            "scaler_clf": MemoryDataset(None),
            "cv_splitter_reg": MemoryDataset(None),
            "cv_splitter_clf": MemoryDataset(None),
