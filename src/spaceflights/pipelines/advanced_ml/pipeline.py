    ...
    return Pipeline(
        [
            ...
            Node(
                ...
                inputs=["X_reg_train_scaled", "y_reg_train", "cv_splitter_reg", "params:advanced_ml"],
            ...
            Node(
                ...
                inputs=["X_clf_train_scaled", "y_clf_train", "cv_splitter_clf", "params:advanced_ml"],
            ...
            Node(
                func=lambda models, params: save_models_with_dvc(models, "regression", params),
            ...
            Node(
                func=lambda models, params: save_models_with_dvc(models, "classification", params),
            ...
            Node(
                ...
                inputs=["regression_evaluation", "classification_evaluation", "params:advanced_ml"],
